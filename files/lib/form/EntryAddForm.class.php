...
class EntryAddForm extends MessageForm {
	...
	public function readFormParameters() {
		...
		if (SHOW_CATEGORY_ENABLE) {
			if (!empty($_POST['enableCategories'])) $this->enableCategories = 1;
		}
		
		// geo location
		$this->enableCoordinates = 0;
		if (SHOW_GEODATA_TYPE == 2 && isset($_POST['enableCoordinates'])) $this->enableCoordinates = 1;
		if (SHOW_GEODATA_TYPE == 3) $this->enableCoordinates = 1;
		...
		if (SHOW_TAB2_ENABLE && SHOW_TAB2_WYSIWYG && isset($_POST['text2'])) $this->text2 = StringUtil::trim(MessageUtil::stripCrap($_POST['text2']));
		if (SHOW_TAB3_ENABLE && SHOW_TAB3_WYSIWYG && isset($_POST['text3'])) $this->text3 = StringUtil::trim(MessageUtil::stripCrap($_POST['text3']));
		if (SHOW_TAB4_ENABLE && SHOW_TAB4_WYSIWYG && isset($_POST['text4'])) $this->text4 = StringUtil::trim(MessageUtil::stripCrap($_POST['text4']));
		if (SHOW_TAB5_ENABLE && SHOW_TAB5_WYSIWYG && isset($_POST['text5'])) $this->text5 = StringUtil::trim(MessageUtil::stripCrap($_POST['text5']));
	...
	public function validate() {
		...
		// texts
		if (SHOW_TAB2_ENABLE && SHOW_TAB2_WYSIWYG) $this->validateText2();
		if (SHOW_TAB3_ENABLE && SHOW_TAB3_WYSIWYG) $this->validateText3();
		if (SHOW_TAB4_ENABLE && SHOW_TAB4_WYSIWYG) $this->validateText4();
		if (SHOW_TAB5_ENABLE && SHOW_TAB5_WYSIWYG) $this->validateText5();
		...
		if (SHOW_IMAGES_FORCE) {
			// misconfiguration?
			$tabExists = 0;
			if (SHOW_IMAGES_TAB == 2 && SHOW_TAB2_ENABLE) $tabExists = 1;
			if (SHOW_IMAGES_TAB == 3 && SHOW_TAB3_ENABLE) $tabExists = 1;
			if (SHOW_IMAGES_TAB == 4 && SHOW_TAB4_ENABLE) $tabExists = 1;
			if (SHOW_IMAGES_TAB == 5 && SHOW_TAB5_ENABLE) $tabExists = 1;
			
			if ($tabExists) {
				if (isset($this->attachmentHandler) && $this->attachmentHandler !== null) {
					$count = count($this->attachmentHandler);
				}
				else throw new UserInputException('images', 'missing');
				
				if (!$count) throw new UserInputException('images', 'missing');
			}
		}
	}
	...
	public function save() {
		...
		if (SHOW_TAB2_ENABLE && SHOW_TAB2_WYSIWYG && !empty($this->text2)) $this->text2 = $this->htmlInputProcessor2->getHtml();
		if (SHOW_TAB3_ENABLE && SHOW_TAB3_WYSIWYG && !empty($this->text3)) $this->text3 = $this->htmlInputProcessor3->getHtml();
		if (SHOW_TAB4_ENABLE && SHOW_TAB4_WYSIWYG && !empty($this->text4)) $this->text4 = $this->htmlInputProcessor4->getHtml();
		if (SHOW_TAB5_ENABLE && SHOW_TAB5_WYSIWYG && !empty($this->text5)) $this->text5 = $this->htmlInputProcessor5->getHtml();
