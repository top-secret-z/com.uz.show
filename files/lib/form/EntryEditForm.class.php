...
class EntryEditForm extends EntryAddForm {
	...
	public function readData() {
		...
		if (!count($_POST)) {
			...
			if ($this->entry->languageID) $this->languageID = $this->entry->languageID;
			...
			if ($this->entry->location) $this->enableCoordinates = 1;
			...
			if (!empty($this->categoryIDs)) $this->enableCategories = 1;
		}
	}
